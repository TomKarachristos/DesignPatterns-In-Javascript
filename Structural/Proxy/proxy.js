...
// A proxy can be instantiated in place of this real subject and allow it to be accessed remotely.
// It can also delay instantiation of the real subject until it is actually needed
